...
export default function DebugMenu({ onStateChange, onTriggerEmergencySelector, onToggleRealTimeMetrics }: DebugMenuProps) {
  ...
  const updateValue = (key: keyof GameState, delta: number) => {
    ...
    console.log(`[DebugMenu] Update ${key}: ${currentState[key]} -> ${newValue}`)
    ...
    <div className="fixed top-4 right-4 z-50">
      ...
      <div className="flex flex-col items-end gap-2">
        <button
          ...
          title={isOpen ? "Close Debug Menu" : "Open Debug Menu"}
        >
        ...
        <div className="bg-gray-900 text-white p-4 rounded-lg shadow-2xl w-80 max-h-96 overflow-y-auto mt-2">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between">
              <label className="text-sm font-medium w-24">Resources:</label>
            ...
            {/* 犯罪率 */}
            <div className="flex items-center justify-between">
              <label className="text-sm font-medium w-24">Crime Rate:</label>
              <div className="flex items-center gap-1">
                <button
            ...
            {/* 逮捕准确率 */}
            <div className="flex items-center justify-between">
              <label className="text-sm font-medium w-24">Accuracy:</label>
              <div className="flex items-center gap-1">
                <button
            ...
            {/* 社区信任度 */}
            <div className="flex items-center justify-between">
              <label className="text-sm font-medium w-24">Trust:</label>
              <div className="flex items-center gap-1">
                <button
          ...
          {onTriggerEmergencySelector && (
            <div className="mt-4 pt-3 border-t border-gray-700">
              <button
                ...
                title="Open Emergency Event Selector"
              >
          ...
          {onToggleRealTimeMetrics && (
            <div className="mt-4 pt-3 border-t border-gray-700">
              <button
                ...
                title="Toggle Real-time Metrics Calculation"
              >
